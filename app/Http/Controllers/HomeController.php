...
class HomeController extends Controller
{
    public function index(){
        ...
        SEOMeta::setTitle("TunaTech");
        SEOMeta::setDescription("TunaTech");
    ...
    public function categorydetail($url)
    {
        ...
        SEOMeta::setTitle($Detay->title.' | TunaTech');
        SEOMeta::setDescription("TunaTech");
        SEOMeta::setCanonical(url()->full());
    ...
    public function partdetail($url)
    {
        ...
        views($Detay)->cooldown(60)->record();
        SEOMeta::setTitle($Detay->title.' | Yedek Parça | TunaTech');
        SEOMeta::setDescription("TunaTech");
        SEOMeta::setCanonical(url()->full());
        return view('frontend.product.index', compact('Detay'));
    }
    ...
    public function contactus(){
        ...
        SEOMeta::setTitle('İletişim | TunaTech');
        SEOMeta::setDescription("TunaTech");
        SEOMeta::setCanonical(url()->full());
